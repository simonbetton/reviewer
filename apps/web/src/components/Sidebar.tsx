...
import { PeerReviewSidebarSection } from "./review/PeerReviewSidebarSection";
...
function SidebarBrand() {
  ...
  return (
    <Link
      ...
      className="sidebar-brand ml-(--workspace-titlebar-content-left) w-fit min-w-0 shrink-0 items-center gap-1 overflow-hidden rounded-md text-foreground outline-hidden ring-ring focus-visible:ring-2"
      to="/"
    >
      <Logo />
...
function Logo() {
  return (
    <div className="border-2 border-primary rounded-full mr-1">
      <div className="border-2 border-gray-800 rounded-full">
        <img src="/icon-192.png" alt="Code Review" className="size-6 rounded-full" />
      </div>
    </div>
  );
}
