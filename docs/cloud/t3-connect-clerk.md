...
T3CODE_PORT=13773 \
  "/Applications/SB Code Review (Alpha).app/Contents/MacOS/SB Code Review (Alpha)"
```
...
```sh
codesign --verify --deep --strict "/Applications/SB Code Review (Alpha).app"
codesign -d --entitlements :- "/Applications/SB Code Review (Alpha).app"
```
